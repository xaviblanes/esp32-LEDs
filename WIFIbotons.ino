...
const char* ssid = "Xavi's Galaxy A12";  // Tu SSID
 ...
 */
  ...
  ptr += "<h3>Utiltzant Mode Estació</h3>\n";
/*
 ...
 */
  if (led1stat)
  {
    ptr += "<p>LED1 Estat: ON</p><a class=\"button button-off\" href=\"/led1off\">OFF</a>\n";
  }
  else
  {
    ptr += "<p>LED1 Estat: OFF</p><a class=\"button button-on\" href=\"/led1on\">ON</a>\n";
  }

  if (led2stat)
  {
    ptr += "<p>LED2 Estat: ON</p><a class=\"button button-off\" href=\"/led2off\">OFF</a>\n";
  }
  else
  {
    ptr += "<p>LED2 Estat: OFF</p><a class=\"button button-on\" href=\"/led2on\">ON</a>\n";
  }
